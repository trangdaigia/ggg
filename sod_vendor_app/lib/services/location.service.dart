...
import 'package:sod_vendor/widgets/bottomsheets/location_permission.bottomsheet.dart';
...
class LocationService {
  ...
  static Addresses? deliveryaddress;
  ...
  static Future<void> prepareLocationListener(BuildContext context) async {
    try {
      ...
      print("Error prepareLocationListener ==> $error");
    }
  }
