...
import 'package:sod_user/models/box.dart';
import 'package:sod_user/models/delivery_address.dart';
import 'package:sod_user/models/driver.dart';
import 'package:sod_user/models/order_attachment.dart';
import 'package:sod_user/models/order_fee.dart';
import 'package:sod_user/models/order_service.dart';
...
import 'package:sod_user/models/taxi_order.dart';
...
class Order {
  Order({
    ...
    this.sharedRideLatitude,
    this.sharedRideLongitude,
    this.rentalVehicleRequests,
    this.sharedRideTickets,
  });
  ...
  String? sharedRideLatitude;
  String? sharedRideLongitude;
  int? sharedRideTickets;
  Trip? rentalVehicleRequests;
  factory Order.fromJson(dynamic json) {
    ...
    return Order(
      ...
      receiveBehalfOrder: json['receive_behalf_order'] != null
          ...
          : null,
      sharedRideLatitude: json['shared_ride_latitude'],
      sharedRideLongitude: json['shared_ride_longitude'],
      rentalVehicleRequests: json['rent_vehicle_request'] != null
          ? Trip.fromJson(json['rent_vehicle_request'])
          : null,
      sharedRideTickets: json['shared_ride_tickets'] ?? 0,
    );
  }
  ...
  get isOrderTracking =>
      ['ready', 'enroute', 'failed', 'cancelled', 'delivered'].contains(status);
