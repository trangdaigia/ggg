...
//
      ...
      if (AppStrings.enableEmailLogin && !AppStrings.enableOTPLogin) {
        ...
        if (AppStrings.otpGateway == "none") {
          await CoolAlert.show(
              ...
              confirmBtnText: "Contact".tr(),
              onConfirmBtnTap: makeCall,
              text: "Please contact us via Zalo or our hotline for support."
                  .tr());
  ...
  makeCall() async {
    launchUrl(Uri(scheme: "tel", path: AppStrings.emergencyContact));
  }
}
