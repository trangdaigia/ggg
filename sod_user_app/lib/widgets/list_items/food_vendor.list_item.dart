...
class FoodVendorListItem extends StatelessWidget {
  ...
  String formatNumberOrder(double? value) {
            ...
            Visibility(
              ...
              child: HStack(
                [
                  ...
                  " ${formatNumberOrder(vendor.distance)} km"
                      .text
                      .minFontSize(6)
                      .size(10)
                      .make(),
              ...
              child: CurrencyHStack(
                [
                 ...
                 "${AppStrings.currencySymbol}"
                  ...
                  Visibility(
                    visible: vendor.minOrder != null,
                    child: "${formatNumberOrder(vendor.minOrder)}"
                        .text
                        .minFontSize(6)
                        .size(10)
                        .gray600
                  ...
                  Visibility(
                    ...
                    child: "${formatNumberOrder(vendor.maxOrder)} "
                        .text
                        .minFontSize(6)
                        .size(10)
                        .gray600
