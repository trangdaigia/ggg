...
class RealEstateWithDetail extends StatelessWidget {
  RealEstateWithDetail(this.realEstate, {super.key});
          ...
          child: VStack([
            ...
            ClipRRect(
              ...
              child: Image.network(
                ...
                height: 150,
                width: double.infinity, // Makes the width fill available space
                fit: BoxFit.cover,
              ),
            ),
            // Description text
            ...
            realEstate.name.text.size(14).color(Colors.black54).make().px8(),
            // Price and area info
            RichText(
              text: TextSpan(
                children: [
