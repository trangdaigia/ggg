...
/// TabBarPropertiesCustom encapsulates [TabController], [TabBar] and [TabBarView]
...
class TabBarPropertiesCustom extends StatefulWidget {
  const TabBarPropertiesCustom({
    Key? key,
    required this.tabs,
...
final int length;
  ...
  @override
  State<StatefulWidget> createState() => TabBarPropertiesCustomState();
}

class TabBarPropertiesCustomState extends State<TabBarPropertiesCustom>
