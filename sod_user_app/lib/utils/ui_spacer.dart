...
class UiSpacer {
  ...
  static Widget divider({double height = 1, double thickness = 1, Color? color}) => Divider(
        height: height,
        thickness: thickness,
        color: color,
      );
  ...
  static Widget cutDivider({
    Color? color,
      ...
      ClipPath(
        clipper: MultiplePointsClipper(Sides.bottom, heightOfPoint: 5, numberOfPoints: 40),
        child: SizedBox(
          height: 8,
