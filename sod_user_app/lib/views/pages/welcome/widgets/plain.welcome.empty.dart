...
import 'package:sod_user/widgets/list_items/plain_vendor_type.vertical_list_item.dart';
        ...
        VStack(
          [
            ...
            VStack(
              [
                UiSpacer.vSpace(60),
                "Our services".tr().text.bold.xl2.color(Utils.textColorByTheme()).make(),
                UiSpacer.vSpace(40),
                //gridview
                CustomVisibilty(
                  visible: HomeScreenConfig.isVendorTypeListingGridView && widget.vm.showGrid && widget.vm.isBusy,
            ...
            if (!widget.vm.checkVendorHasService()) ...[
              UiSpacer.vSpace(20),
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(color: Colors.grey[400]!, blurRadius: 8, spreadRadius: 3),
                  ],
                ),
                child: GestureDetector(
                  onTap: () {
                    List<VendorType> v = widget.vm.vendorTypes.where((e) => e.slug == "taxi").toList();
              ...
              SizedBox(
                ...
                child: HStack(
                  ...
                  [
                    CustomListView(
                      scrollDirection: Axis.horizontal,
                      refreshController: widget.vm.refreshController,
                      dataSet: widget.vm.deliveryAddressesViewModel!.deliveryAddresses,
                      isLoading: widget.vm.busy(widget.vm.deliveryAddressesViewModel!.deliveryAddresses),
                      errorWidget: LoadingError(
                        onrefresh: widget.vm.deliveryAddressesViewModel!.fetchDeliveryAddresses,
                      ),
                      itemBuilder: (context, index) {
                        final IconData icon;
                        final address = widget.vm.deliveryAddressesViewModel!.deliveryAddresses[index];
                          ...
                          child: VStack(
                            ...
                            [
                              ElevatedButton(
                                ...
                                onPressed: () {
                                  widget.vm.deliveryAddressesViewModel!.editDeliveryAddress(address);
                                },
                                child: Icon(icon, size: 20),
                              ),
                              Text("${address.name?.toString().toUpperCase()}", overflow: TextOverflow.ellipsis),
                            ],
                          ),
                        );
                      },
                              ...
                              Stack(
                                ...
                                children: [
                                  ElevatedButton(
                                    ...
                                    onPressed: () {
                                      widget.vm.deliveryAddressesViewModel!.newDeliveryAddressPressed();
                                    },
                                    child: Icon(FlutterIcons.heart_ant, size: 20),
                                  ),
                                  Icon(Icons.add, color: Colors.blue).box.white.roundedFull.make(),
                                ],
                              ),
                              Text("${"New".tr().toString().toUpperCase()}", overflow: TextOverflow.ellipsis),
                            ],
                          ),
                        ),
                      ],
