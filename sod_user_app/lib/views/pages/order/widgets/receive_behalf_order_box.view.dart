          ...
          [
            ...
            HStack(
              [
                ...
                //
                "${vm.order.receiveBehalfOrder!.box!.building!.area!.name}".text.make().expand(),
              ],
            ...
            HStack(
              [
                ...
                VStack(
                  [
                    "${vm.order.receiveBehalfOrder!.box!.building!.address}".text.make(),
                    "${vm.order.receiveBehalfOrder!.box!.name}".text.color(Vx.gray400).sm.light.make(),
                  ],
                ).expand(),
              ],
              crossAlignment: CrossAxisAlignment.start,
