...
import 'package:vietmap_gl_platform_interface/vietmap_gl_platform_interface.dart' as vietMapInterface;
        ...
        ? Stack(
          children: [
            vietMapGl.VietmapGL(
              ...
              onMapCreated: (vietMapGl.VietmapController controller){
                vietMapController = controller;
                sourceIcon = Image.asset(
