...
import 'package:sod_user/view_models/delivery_address/edit_delivery_addresses.vm.dart';
...
class EditDeliveryAddressesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<EditDeliveryAddressesViewModel>.reactive(
      viewModelBuilder: () => EditDeliveryAddressesViewModel(context, deliveryAddress),
          ...
          body: Form(
            ...
            child: VStack(
              [
                ...
                CustomTextFormField(
                  labelText: "Name".tr(),
                  isReadOnly: vm.nameTEC.text.toLowerCase() == "home" || vm.nameTEC.text.toLowerCase() == "work",
