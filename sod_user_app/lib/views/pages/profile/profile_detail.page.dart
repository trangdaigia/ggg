...
import 'package:sod_user/view_models/profile_detail.vm.dart';
...
import 'package:sod_user/views/pages/profile/review_card.dart';
                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        "${model.currentUser?.name ?? 'User name'.tr()}"
                            .text
                            .size(20)
                            .bold
                            .make(),
                        if (!model.busy(model.currentUser)) ...[
                          Row(
                            ...
                            children: [
                              '${(double.parse(model.currentUser?.rating ?? "0")).toStringAsFixed(1)}'
                                  .text
                                  .bold
                                  .size(16)
                                  .make()
                  ...
                  child: model.busy(model.myReview)
                      ...
                      : CustomListView(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ReviewCard(
                              photo: model.currentUser?.photo,
                              name: model.currentUser?.name ?? 'User name'.tr(),
                              review: review.review,
                              rating: review.rating,
                              createdAt: review.createdAt,
                            ).px(16).py(8);
