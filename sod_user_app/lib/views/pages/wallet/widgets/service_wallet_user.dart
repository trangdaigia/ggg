...
class ServiceWalletUser extends StatefulWidget {
  const ServiceWalletUser({
    this.viewmodel,
    Key? key,
  }) : super(key: key);
  ...
  @override
  State<ServiceWalletUser> createState() => _WalletManagementViewState();
}

class _WalletManagementViewState extends State<ServiceWalletUser>
              ...
              [
                ...
                BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      Colors.blue.shade500, // Màu xanh dương đậm
                      Colors.blue.shade300, // Màu xanh dương nhạt
                    ],
