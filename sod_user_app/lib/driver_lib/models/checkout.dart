...
class CheckOut {
  ...
  factory CheckOut.fromJson(Map<String, dynamic> json) {
    return CheckOut(
      subTotal: json["sub_total"] == null ? 0.00 : double.parse(json["sub_total"].toString()),
      discount: json["discount"] == null ? 0.00 : double.parse(json["discount"].toString()),
      deliveryDiscount: json["delivery_discount"] == null ? 0.00 : double.parse(json["delivery_discount"].toString()),
      deliveryFee: json["delivery_fee"] == null ? 0.00 : double.parse(json["delivery_fee"].toString()),
      tax: json["tax"] == null ? 0.00 : double.parse(json["tax"].toString()),
      total: json["total"] == null ? 0.00 : double.parse(json["total"].toString()),
      totalWithTip: json["total_with_tip"] == null ? 0.00 : double.parse(json["total_with_tip"].toString()),
      ...
      // cartItems: json["products"] == null ? null : List<Cart>.from(json["products"].map((x) => Cart.fromJson(x))),
      deliverySlotDate: json["delivery_slot_date"] == null ? "" : json["delivery_slot_date"],
      deliverySlotTime: json["delivery_slot_time"] == null ? "" : json["delivery_slot_time"],
      photo: json["photo"] == null ? null : File(json["photo"]),
      // coupon: json["coupon"] == null ? null : Coupon.fromJson(json["coupon"]),
      token: json["token"] == null ? null : json["token"],
      deliveryFeeToken: json["delivery_fee_token"] == null ? null : json["delivery_fee_token"],
      //
      // fees: json["fees"] == null ? [] : List<Fee>.from(json["fees"].map((x) => Fee.fromJson(x))),
      totalFee: json["total_fee"] == null ? 0.00 : double.parse(json["total_fee"].toString()),
    );
  }
